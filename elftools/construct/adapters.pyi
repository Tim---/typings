from .core import AdaptationError as AdaptationError, Adapter as Adapter, Pass as Pass
from .lib import (
...
from .lib.py3compat import BytesIO as BytesIO, decodebytes as decodebytes
...
class MappingAdapter(Adapter):
    ...
    def __init__(
        self, subcon, decoding, encoding, decdefault=..., encdefault=...
    ) -> None: ...
...
class CStringAdapter(StringAdapter):
    ...
    def __init__(
        self, subcon, terminators: bytes = b"\x00", encoding: Incomplete | None = None
    ) -> None: ...
...
class PaddingAdapter(Adapter):
    ...
    strict: Incomplete
    def __init__(
        self, subcon, pattern: bytes = b"\x00", strict: bool = False
    ) -> None: ...
